...
const EventoHistorial: FC<EventoHistorialProps> = ({ data, onEdit }) => {
  return (
    <div className='flex flex-row border-y border-gray-200 p-3 px-5 justify-between items-start bg-white text-gray-600 shadow'>
      <div className='flex flex-col'>
        <div className='flex flex-row'>
          <p>Día y hora:</p>
          <div className='pl-5 flex flex-row'>
            <p className='pl-1'>{data.dia}</p>
            <p className='pl-1'>{data.hora}</p>
          </div>
        </div>
        <div className='flex flex-row'>
          <p>Evento:</p>
          <p className='pl-3'>{data.event}</p>
        </div>
        <div className='flex flex-row'>
          <p>Comentarios:</p>
          <p className='pl-3'>{data.comments}</p>
        </div>
        <div className='flex flex-col'>
          ...
          <div className='flex flex-col pt-1'>
            <div className='flex flex-col pl-3 border border-gray-200 p-1 px-2'>
              ...
              <div className='flex flex-row'>
                ...
                <p className='pl-2'>El campo "Evento" ha cambiado de "Registrar Pausa" a "Fichaje de entrada"</p>
              </div>
            </div>
            <div className='flex flex-col pl-3 border border-gray-200 p-1 px-2'>
              <div className='flex flex-row'>
