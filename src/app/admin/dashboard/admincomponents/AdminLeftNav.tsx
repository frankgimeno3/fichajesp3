    ...
    <div className="flex flex-col min-h-screen w-80 bg-white border-r border-gray-200 p-4 pl-6 shadow-sm text-gray-800  " style={{"width":"170px", "fontSize": '10px'}}  >
      ...
      <div className="mb-4">
        ...
        {isFichajesOpen && (
          <div className="ml-4 mt-2 space-y-2">
            <button
              onClick={() => router.push('/admin/dashboard/fichajes')}
            ...
            <button
              onClick={() => router.push('/admin/dashboard/fichajes/historial')}
              className="block  px-3 py-1.5 text-left rounded hover:bg-blue-950 w-full
              hover:text-white transition cursor-pointer"
            >
      ...
      <div className="mb-4">
        ...
        {isComercialOpen && (
          <div className="ml-4 mt-2 space-y-2">
            <button
              onClick={() => router.push('/admin/dashboard/comercial')}
              className="block  px-3 py-1.5 text-left rounded hover:bg-blue-950 w-full
              hover:text-white transition cursor-pointer"
            >
              Seguimientos
           ...
           <button
              onClick={() => router.push('/admin/dashboard/comercial/propuestas')}
              className="block  px-3 py-1.5 text-left rounded hover:bg-blue-950 w-full
              hover:text-white transition cursor-pointer"
            >
              Propuestas
             ...
             <button
              onClick={() => router.push('/admin/dashboard/comercial/tarifas')}
              className="block  px-3 py-1.5 text-left rounded hover:bg-blue-950 w-full
              hover:text-white transition cursor-pointer"
            >
              Tarifas
      ...
      <div className="mb-4">
        ...
        {isProduccionOpen && (
          <div className="ml-4 mt-2 space-y-2">
            <button
              onClick={() => router.push('/admin/dashboard/produccion/materiales')}
              className="block  px-3 py-1.5 text-left rounded hover:bg-blue-950 w-full
              hover:text-white transition cursor-pointer"
            >
              Materiales
            ...
            <button
              onClick={() => router.push('/admin/dashboard/produccion/preferentes')}
              className="block  px-3 py-1.5 text-left rounded hover:bg-blue-950 w-full
              hover:text-white transition cursor-pointer"
            >
              Páginas preferentes
      ...
      <div className="mb-4">
        ...
        {isClientesOpen && (
          <div className="ml-4 mt-2 space-y-2">
            <button
              onClick={() => router.push('/admin/dashboard/cuentas')}
              className="block  px-3 py-1.5 text-left rounded hover:bg-blue-950 w-full
              hover:text-white transition cursor-pointer"
            >
              Cuentas
             ...
             <button
              onClick={() => router.push('/admin/dashboard/cuentas/contactos')}
              className="block  px-3 py-1.5 text-left rounded hover:bg-blue-950 w-full
              hover:text-white transition cursor-pointer"
            >
              Contactos
      ...
      <div className="mb-4">
        ...
        {isAdministracionOpen && (
          <div className="ml-4 mt-2 space-y-2">
            <button
              onClick={() => router.push('/admin/dashboard/administracion/controladministrativo')}
              className="block  px-3 py-1.5 text-left rounded hover:bg-blue-950 w-full
              hover:text-white transition cursor-pointer"
            >
            ...
            <button
              onClick={() => router.push('/admin/dashboard/administracion/pendiente')}
              className="block  px-3 py-1.5 text-left rounded hover:bg-blue-950 w-full
              hover:text-white transition cursor-pointer"
            >
              Pendiente Cobro
             ...
             <button
              onClick={() => router.push('/admin/dashboard/administracion/informes')}
              className="block  px-3 py-1.5 text-left rounded hover:bg-blue-950 w-full
              hover:text-white transition cursor-pointer"
            >
